        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 100%;">
          ...
          <form action="" method="GET">
            <ul class="nav nav-pills flex-column mb-auto">
              <li class="nav-item">
                <button type="submit" href="#" class="nav-link active w-100" aria-current="page">
                  FILTRAR
                </button>
                ...
                <nav aria-label="Page navigation example" style="float: right;">
                  <ul class="pagination">
                    ...
                    <li class="page-item <?php if($paginaActual == 1){echo "disabled";}?>">
                      <a <?php if($paginaActual == 1){echo 'tabindex="-1"';}?> class="page-link" href="<?= SERVERURL ?>pages/products.php? <?= $variablesGet."&page=". ($paginaActual-1)?>">Previous</a>
                    </li>
                    <?php
                    ...
                    <li class="page-item <?php if($cantPaginas == $paginaActual ){echo "disabled";}?>">
                      <a <?php if($cantPaginas == $paginaActual){echo 'tabindex="-1"';}?> class="page-link" href="<?= SERVERURL ?>pages/products.php? <?= $variablesGet."&page=". ($paginaActual+1)?>">Next</a>
                   </li>
                  </ul>
                </nav>
              </div>
